...
# --- 2. CSS (CLEAN WHITE THEME & GRID TABLES) ---
st.markdown("""
<style>
    ...
    /* BUTTONS */
    .stButton > button {
        width: 100%; height: 45px; border-radius: 6px; font-weight: 600; font-size: 14px; 
        border: 1px solid #D1D5DB; background-color: #FFFFFF; color: #000000; 
    ...
    div[data-testid="column"]:nth-of-type(3) button { 
        ...
        color: #000000 !important; border: 1px solid #E5E7EB !important; background: transparent !important;
    }
    
    /* METRICS */
    [data-testid="stMetricValue"] { font-size: 24px; font-weight: 700; color: #000000; }
    ...
    .custom-table th, .custom-table td {
        border: 1px solid #E5E7EB; /* GRIDLINES */
        padding: 10px 12px;
        text-align: left;
    }
...
if st.session_state.nav != "Home":
    ...
    c2.markdown("<h2 style='text-align:center; color:#000000; margin:0;'>⚡ Shine Arc</h2>", unsafe_allow_html=True)
