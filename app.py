...
<style>
    ...
    .section-header { border-left: 5px solid #4F46E5; padding-left: 10px; margin-top: 30px; margin-bottom: 15px; color: #111827; font-size: 1.15rem; font-weight: 700; }
</style>
